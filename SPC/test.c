...
int main(){
    ...
    //          }
    //      }
  while(roman_Number[i]){ //checking input //i=1
         if(digit(roman_Number[i]) >= digit(roman_Number[i+1])) // index 0 value and index 1 value 
            //For Eg: VI (I-0 index) (V- 1 index) I>=V -> False
